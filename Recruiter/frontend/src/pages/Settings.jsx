...
const Settings = () => {
    ...
    return (
        <>
            ...
            >
                <form onSubmit={handleSubmit} className='flex flex-1 flex-col justify-center items-center gap-5 scrollbar-width-5'>
                        ...
                        <ReactQuill theme="snow"
                            ...
                            placeholder="Upload Your Company Logo Above and Write Company Description"
                        >
                        </ReactQuill>
